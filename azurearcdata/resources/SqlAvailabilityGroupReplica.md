...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		_, err := azurearcdata.NewSqlAvailabilityGroupReplica(ctx, "sqlAvailabilityGroupReplica", &azurearcdata.SqlAvailabilityGroupReplicaArgs{
			Location: pulumi.String("southeastasia"),
			Properties: azurearcdata.SqlAvailabilityGroupReplicaResourcePropertiesResponse{
				...
				ReplicaId:   pulumi.String("00000000-1111-2222-3333-444444444444"),
				ReplicaName: pulumi.String("testSqlServerInstance"),
...
import com.pulumi.azurenative.azurearcdata.SqlAvailabilityGroupReplica;
import com.pulumi.azurenative.azurearcdata.SqlAvailabilityGroupReplicaArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        var sqlAvailabilityGroupReplica = new SqlAvailabilityGroupReplica("sqlAvailabilityGroupReplica", SqlAvailabilityGroupReplicaArgs.builder()        
            .location("southeastasia")
            .properties(Map.ofEntries(
                ...
                Map.entry("replicaId", "00000000-1111-2222-3333-444444444444"),
                Map.entry("replicaName", "testSqlServerInstance"),
...
const sqlAvailabilityGroupReplica = new azure_native.azurearcdata.SqlAvailabilityGroupReplica("sqlAvailabilityGroupReplica", {
    location: "southeastasia",
    properties: {
        configure: {
            availabilityModeDesc: "SYNCHRONOUS_COMMIT",
...
```yaml
resources:
  sqlAvailabilityGroupReplica:
    type: azure-native:azurearcdata:SqlAvailabilityGroupReplica
    properties:
      location: southeastasia
      properties:
        configure:
